        ...
        <div className="h-[62px] pt-[10px] ml-6">
            <input
                ...
                className={`thumb thumb--zindex-3 ${
                    lastSelected == "min" ? "thumb--zindex-5" : null
                } `}
            />
            <input
                type="range"
                ...
                className={`thumb thumb--zindex-3 ${
                    lastSelected == "max" ? "thumb--zindex-5" : null
                } `}
            />

            <div className="relative w-[300px]">
                <div
                    className={`absolute w-[300px] mt-[-3px] 
                          h-[5px]
                          bg-gray-600
                          `}
                    onClick={() => {}}
                ...
                <div
                    ref={range}
                    className={`absolute h-[5px] w-[300px] bg-gray-300 z-10 mt-[-3px] rounded`}
                    onClick={() => {}}
                ></div>

                <input
                    className={`text-white text-center bg-gray-500 
